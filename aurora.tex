...
\begin{figure}[!htpb]
    \begin{center}
        ...
        \end{bytefield}
        \caption{Data block structure \cite{auroraSpec}}
        \label{fig:data}
    \end{center}
\end{figure}
...
\begin{figure}[!htpb]
    \begin{center}
        ...
        \end{bytefield}
        \caption{Separator-7 block structure \cite{auroraSpec}}
        \label{fig:sep7}
    \end{center}
\end{figure}
\newpage
...
\begin{figure}[!htpb]
    \begin{center}
        \begin{bytefield}[endianness=little,bitwidth=0.8em, bitheight=1.2em]{32}
            ...
            \bitbox{8}{\texttt{\footnotesize D3}} & \bitbox{8}{\texttt{\footnotesize D2}} & \bitbox{8}{\texttt{\footnotesize D1}} & \bitbox{8}{\texttt{\footnotesize D0}}
        \end{bytefield}
        \caption{Separator block structure \cite{auroraSpec}}
        \label{fig:sep}
    \end{center}
\end{figure}
...
\begin{figure}[!htpb]
    \begin{center}
        \begin{bytefield}[endianness=little,bitwidth=0.8em, bitheight=1.2em]{32}
            ...
            \bitbox{8}{\texttt{\footnotesize D3}} & \bitbox{8}{\texttt{\footnotesize D2}} & \bitbox{8}{\texttt{\footnotesize D1}} & \bitbox{8}{\texttt{\footnotesize D0}}
        \end{bytefield}
        \caption{User K-Block structure \cite{auroraSpec}}
        \label{fig:kblock}
    \end{center}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \begin{center}
        ...
        \end{bytefield}
    \end{center}
    \caption{Idle block structure \cite{auroraSpec}}
    \label{fig:idle}
\end{figure}
\FloatBarrier
%
