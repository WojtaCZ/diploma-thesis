...
A control transfer is started by an eight-byte-long \emph{Setup Packet}, which contains the following fields: \cite{usb11_spec}
...
\begin{figure}[htpb]
    \begin{center}
        ...
        \end{bytefield}
        \caption{Setup packet structure \cite{usb11_spec}}
...
The pulse injection circuit is fed by a fast timer output. The width of the timer pulse directly influences the width and amplitude of the generated pulse, which is used for testing the frontends. The size of this pulse has been fixed, and the pulses are generated with a period of \SI{100}{\micro\second}.
\newpage
\section{User board}
